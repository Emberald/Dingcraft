...
public class RenderArrowVoid extends Render
{
    private static final ResourceLocation arrowTextures = new ResourceLocation(Dingcraft.MODID + ":textures/entity/arrowDing.png");

    public RenderArrowVoid(RenderManager p_i46193_1_)
    {
        super(p_i46193_1_);
    }

    public void doRender(EntityArrowVoid p_180551_1_, double p_180551_2_, double p_180551_4_, double p_180551_6_, float p_180551_8_, float p_180551_9_)
    {
    ...
    protected ResourceLocation getEntityTexture(EntityArrowVoid p_180550_1_)
    {
    ...
    {
        return this.getEntityTexture((EntityArrowVoid) (entity));
    }

    public void doRender(Entity entity, double x, double y, double z, float p_76986_8_, float partialTicks)
    {
        this.doRender((EntityArrowVoid) (entity), x, y, z, p_76986_8_, partialTicks);
    }
}